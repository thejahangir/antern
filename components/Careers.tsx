...
const jobs: Job[] = [
  { 
    ...
    description: "Strong C++ with exposure to Rust, or Rust experience with strong backend fundamentals (concurrency, networking, performance, security basics). We can keep Rust as an optional skill, but it would be better if we are able to find a good C++ developer with at least theoretical knowledge in Rust",
    requirements: ["Backend experience is the “must”", "Preference for candidates who have built backend systems that interface with hardware.", "Linux familiarity and debugging skills expected."],
  ...
  { 
    ...
    education: "BTech/MTech",
    postedDate: "10 April 2026",
    description: "USB track: USB products experience (USB hubs preferred) + serial bus protocol development/debug (SPI, I2C, UART) + MISRA coding practices or PCIe track: PCIe products experience (PCIe switches preferred) + serial bus protocol development/debug (SPI, I2C, UART) + MISRA coding practices",
    requirements: ["Primarily C / bare-metal firmware; may include FreeRTOS; not Linux-based"],
  ...
  },
  {
    ...
    education: "BTech/MTech",
    postedDate: "10 April 2026",
    description: "We are looking for Senior developer for Java to help in modernization of applications. The candidate must have strong client facing experience, excellent interpersonal, written, and oral communication skills",
    requirements: ["Java 8 ", "Spring Boot", "Microservices", "RESTful APIs", "PostgreSQL", "Git", "Agile/Scrum, GIT, BitBucket, JIRA, JFrog, Jenkins, Nexus"],
    perks: ["Relocation Package", "Health Concierge", "Annual Retreat"]
  },
  {
    id: "ANT-BLR-004",
    ...
    postedDate: "10 April 2026",
    description: "We are looking for a skilled Senior Automation Tester to join our team. The ideal candidate will be an expert in Cypress automation, JavaScript, Jasmine framework, and possess 6+ years of experience in quality assurance. As a Senior Automation Tester, you will play a key role in analyzing the functionality of application and design automated tests to validate functionality in our transformation projects, ensuring the delivery of high-quality software through efficient and effective testing processes.",
    requirements: ["Create and execute Cypress automation testing for our transformation projects.", "Design and implement automated test scripts using JavaScript and Jasmine framework.", "Collaborate with development teams to identify and resolve issues.", "Maintain and improve existing automation frameworks.", "Participate in code reviews and provide technical guidance to junior team members.", "Stay updated with the latest trends and best practices in automation testing. Refactoring and extending frameworks whenever necessary."],
    perks: ["Relocation Package", "Health Concierge", "Annual Retreat"]
  },
  ...
  return (
    <div className="bg-white min-h-screen selection:bg-[#0085F7] selection:text-[#fff]">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center overflow-hidden bg-[#0A0A0A]">
        ...
        >
          <img 
            src="https://images.unsplash.com/photo-1561489422-45de3d015e3e?q=80&w=2000" 
              ...
              <div className="bg-white p-8 md:p-16 relative group overflow-hidden">
                {subscriptionState === 'success' ? (
                  <div className="py-12 text-center animate-in fade-in zoom-in-95 duration-500">
                    ...
                    <h3 className="text-3xl font-black uppercase tracking-tight text-[#1A1A1A] mb-4">Node <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0085F7] to-[#00A94B]">Integrated</span></h3>
