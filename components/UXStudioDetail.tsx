            ...
            {[
              ...
              <div key={i} className="bg-white p-5 md:p-6 group hover:bg-[#1A1A1A] transition-all duration-500 flex flex-col justify-between min-h-[200px]">
                <div>
                  ...
                  <h3 className="text-lg font-black tracking-tight mb-2 text-[#1A1A1A] group-hover:text-white transition-colors text-4xl md:text-5xl capitalize">
                    {item.title}
                  </h3>
                  ...
                  <div className="p-5 md:p-6 bg-white/[0.02] hover:bg-white/[0.05] transition-all duration-700 flex flex-col justify-between group/card min-h-[160px]" key={i}>
                    <div>
                      <div className="flex items-center gap-4 mb-3">
                        ...
                        <h3 className="text-[13px] md:text-sm font-black tracking-tight group-hover/card:text-[#0085F7] transition-colors leading-none text-4xl md:text-5xl capitalize">{pillar.title}</h3>
                      </div>
      ...
      <section className="py-10 md:py-12 bg-white border-t border-gray-100 overflow-hidden relative text-center">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={onInitiateStrategy}
              className="px-6 py-3 md:px-8 md:py-4 bg-[#0085F7] text-white text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em] hover:bg-[#339DFF] hover:text-white transition-all shadow-[0_10px_20px_rgba(0,133,247,0.2)] hover:shadow-[0_15px_30px_rgba(0,133,247,0.3)] transform hover:-translate-y-0.5"
            >
