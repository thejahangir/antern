            ...
            {[
              ...
              <div key={i} className="bg-white p-10 group hover:bg-[#1A1A1A] transition-all duration-500 flex flex-col justify-between min-h-[420px]">
                <div>
                  ...
                  <p className="text-gray-500 group-hover:text-gray-400 font-normal leading-relaxed mb-10 transition-colors text-sm">
                    {item.desc}
                  </p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 mb-32">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-gray-100 border border-gray-100">
            ...
            <div className="bg-white p-12 group hover:bg-[#1A1A1A] transition-all duration-700">
              ...
              <p className="text-gray-500 group-hover:text-gray-400 font-normal leading-relaxed mb-12 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                <div className="p-8">
                    ...
                    <p className="text-sm text-gray-500 font-normal leading-relaxed">Reducing cognitive load by aligning interface patterns with existing mental models and learned behaviors.</p>
                </div>
                <div className="p-8 md:border-x border-gray-100">
                    ...
                    <p className="text-sm text-gray-500 font-normal leading-relaxed">Visualizing mission-critical metrics with absolute precision, ensuring zero visual clutter in high-stakes environments.</p>
                </div>
                <div className="p-8">
                    <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-[#004b23] mb-4">03. Response</h4>
                    <p className="text-sm text-gray-500 font-normal leading-relaxed">Engineering real-time feedback loops that empower users to act with confidence and absolute strategic velocity.</p>
                </div>
            </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="mt-24 pt-16 border-t border-white/10">
            <div className="flex flex-col lg:flex-row items-center justify-between p-12 bg-white/[0.03] backdrop-blur-md gap-12 border border-white/10 rounded-sm">
                <div className="max-w-2xl">
                    <p className="text-xl md:text-2xl font-normal text-gray-400 italic leading-relaxed">
