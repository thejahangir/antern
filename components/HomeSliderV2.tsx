...
export const HomeSliderV2: React.FC<HomeSliderV2Props> = ({ onNavigateToProduct }) => {
  ...
  const slides = [
    {
      ...
      description: 'An Interview-as-a-Service platform that enables expert-led technical interviews at scale. Evaluates candidates efficiently with structured feedback and insights.',
    ...
    },
    {
      ...
      description: 'A smart assessment platform designed for fast, fair, and accurate candidate evaluation. Automates testing and scoring to streamline hiring.',
    ...
    },
    {
      ...
      description: 'An advanced resume parsing and matching engine powered by semantic intelligence. Understands context for highly accurate JD-to-profile matching.',
    ...
    },
    {
      ...
      description: 'A comprehensive project and delivery management platform for enterprise teams. Provides real-time visibility into projects and resources.',
  ...
  return (
    <section className="relative w-full h-[600px] xl:h-[700px] overflow-hidden bg-white font-sans">
      {/* Slider Track */}
      <div 
      ...
      >
        {slides.map((slide, i) => (
          <div key={slide.id} className="w-full h-full flex-shrink-0 flex text-white relative">
            ...
            <div className="hidden md:flex flex-col w-1/4 h-full">
            ...
            <div className={`w-full md:w-1/4 h-full flex flex-col justify-center px-10 xl:px-14 py-12 relative ${slide.color} overflow-hidden`}>
              <div className="absolute inset-0 bg-black/5 mix-blend-multiply"></div>
              
              <div className="relative z-10">
                 {/* Title */}
                 <h1 className="text-4xl lg:text-[40px] xl:text-5xl font-bold text-white leading-tight mb-8 tracking-tight">
                    Antern <br/>
                    ...
                    {slides.map((s, idx) => (
                      <li key={s.id}>
                        <button 
                          ...
                          className={`text-left transition-all duration-300 hover:translate-x-1 ${idx === i ? 'text-white font-bold' : 'text-white/60 hover:text-white hover:opacity-100'}`}
                        >
                          {s.title}
                        </button>
                      </li>
                 ...
                 <div className="mt-12 h-32">
                   <p className="text-white/90 text-sm xl:text-[15px] font-light leading-relaxed mb-6 line-clamp-3">
                     {slide.description}
                   </p>
                   <button
